  ...
  <body class="min-vh-100 d-flex justify-content-center align-items-center p-4" >
  	<div class="col-md-4">
  		<div class="d-flex flex-column align-items-center">
	  		<h1 style="color: #465771;">Add Menu</h1>
		    <div>
		    	<a href="home.php" class="btn btn-abu">Home</a>
		    	<a href="./controller/logout.php" class="btn btn-danger">Logout</a>
		    </div>
	  	</div>
	  	<form class="mt-4 d-flex flex-column" method="POST" action="./controller/query_add.php">
				<div class="row mb-3">
			    <label for="inputMenu" class="fw-bold col-sm-3 col-form-label">Menu</label>
			    <div class="col-sm-9">
			      <input type="text" name="menu" class="form-control" id="inputMenu">
			    </div>
			  </div>
			  <div class="row mb-3 align-items-center">
			    ...
			    <div class="col-sm-9">
			    	...
			    	<div class="form-check form-check-inline">
						  <input class="form-check-input" type="radio" name="category" id="drink" value="drink">
			  ...
			  <div class="row mb-3">
			    ...
			    <div class="col-sm-9">
			      <input type="number" name="price" class="form-control" id="inputMenu">
			    </div>
			  </div>
				<button type="submit" class="btn btn-primary btn-abu align-self-center">	Add Menu
				</button>
	    </form>
  	</div>
