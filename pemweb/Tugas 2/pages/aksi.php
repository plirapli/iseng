...
<head>
  ...
  <link rel="shortcut icon" href="../assets/favicon/form.svg" type="image/x-icon">
  ...
  <main class="main main-pt">
    <div class="container-custom">
      <div class="mb-4">
        ...
        <p>
          Pengisian formulir telah berhasil dilakukan. Silakan kembali ke
          halaman utama.
        </p>
      </div>
      <a class="text-dark" href="home.php">
        <button type="button" class="btn btn-black w-100">Kembali</button>
      </a>
    </div>
  </main>
